    ...
    return (
        <div>
            <div className={style.container}>
                <div className={style.divContainer}></div>
                {messageToggle?null:<div className={style.toast}>
                    The Pokemon was create succesful. 
                      Go back to home to check it.
                </div>}
                <form onSubmit={createPokemon} className={style.form}>
                    <h2>Please, write in each item</h2>
                    <div className={style.eachItem}>
                        <label htmlFor="name" className={style.label}>name</label>
                        <input type="text" name="name" value={pokeData.name} onChange={handleChange} className={style.input} />
                    </div>
